...
const customerCentric = [
  {
    title: "1 Billion workforce will be added in the next 10 years",
    icon: Shield,
  },
  {
    title:
      "80% working in blue-collar jobs: manufacturing, security, logistics, textile, retail, agriculture, construction",
    icon: Code,
  },
  {
  ...
  {
    title: "WhatsApp is the dominate social media app",
    icon: Receipt,
  },
];
    ...
    <>
      <section className="hero-section container">
        <div className="intro-texts">
          ...
          <p className="intro-text">
            "Boss, can I have some juice?" one of our dedicated sales agents
            asked. "I don't even have money for transport tomorrow, boss. Things
            are bad," he continued. "It's just the second week of the month! If
            I give you money, it means we won't have money to restock tomorrow,
            and we won't sell anything," I reluctantly explained.
          </p>
          <p>
      ...
      <section className="container landscapeSection">
        ...
        <ul className="flex gap-8 flex-wrap justify-center my-16 mx-auto">
          {customerCentric.map(({ title, icon }) => (
            <li
      ...
      <section className="container ">
        ...
        <ul className="flex gap-4 flex-wrap justify-center mb-32 gap-y-8">
          {teamMembers.map(({ name, role, img }) => (
            <li className="p-5 rounded-[8px] border border-[#FFECE5]" key={role}>
